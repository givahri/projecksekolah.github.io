...
$title = "Tambah User - SMKN 1 MOILONG";
...
if ($msg == 'notimage'){
    $alert = '<div class="alert alert-warning alert-dismissible fade show" role="alert">
    <i class="fa-solid fa-xmark"></i> Tambah user gagal, file yang anda upload bukan gmbar..
    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
  </div>';
}
                        ...
                        <div class="card-body">
                          <div class="row">
                            ...
                            <div class="mb-3 row">
                                ...
                                id="Username" Name="Nama " maxlength="20" required>
                                </div>
                            </div>
                            ...
                            <div class="col-4 text-center px-5">
                                ...
                                <small class="text-secondary"> Pilih foto PNG,JPG, atau JPEG ukuran maksimal 1MB </small>
